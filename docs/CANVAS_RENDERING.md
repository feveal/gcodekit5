...
```rust
use gcodekit5::visualizer::{Visualizer2D, render_toolpath_to_path, render_grid_to_path};
...
Implemented for issue **gcodekit5-83**: "Convert visualizer from slint image element to canvas element"
