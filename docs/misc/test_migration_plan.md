# Test Migration Plan - Issue gcodekit5-4
...
- **Already migrated**: visualizer module (gcodekit5-1)
...
3. ✅ Add necessary imports (use `gcodekit5::` crate path)
...
```rust
use gcodekit5::firmware::grbl::capabilities::*;
...
- Follow visualizer module pattern (gcodekit5-1) as reference
