...
The `gcodekit5-designer` crate provides basic 2D drawing and G-code generation capabilities. However, the current implementation has several limitations and inefficiencies:
...
- [x] Migrated all designer UI elements to `gcodekit5-designer` crate.
