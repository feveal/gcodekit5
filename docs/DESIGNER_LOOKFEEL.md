...
The current Designer component (`crates/gcodekit5-designer/ui/designer.slint`) implements a functional 2D CAD interface. The aesthetic is utilitarian, relying on a mix of dark and light themes.
