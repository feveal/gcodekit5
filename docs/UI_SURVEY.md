...
5.  **Device Manager** (`../gcodekit5-devicedb/ui/device_manager.slint`)
6.  **Device Config** (`ui_panels/config_settings.slint`)
7.  **Visualizer** (`../gcodekit5-visualizer/ui/gcode_visualizer.slint`)
8.  **Designer** (`../gcodekit5-designer/ui/designer.slint`)
