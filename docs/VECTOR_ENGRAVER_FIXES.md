...
**Code Changes** (crates/gcodekit5-parser/src/processing/vector_engraver.rs):
...
## Files Modified
- `crates/gcodekit5-parser/src/processing/vector_engraver.rs` - Core fix
- `crates/gcodekit5-camtools/src/vector_engraver.rs` - Synced fix
