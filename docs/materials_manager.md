...
- **Storage Location**: `~/.config/gcodekit5/custom_materials.json` (Linux/macOS) or `%APPDATA%\gcodekit5\custom_materials.json` (Windows)
...
```rust
use gcodekit5::ui::MaterialsManagerBackend;
use gcodekit5::data::materials::{Material, MaterialId, MaterialCategory};
