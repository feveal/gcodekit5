...
The current `ConfigSettingsPanel` (`crates/gcodekit5-ui/ui_panels/config_settings.slint`) implements a functional but basic "Light Mode" design that is inconsistent with the recently updated "Dark Mode" aesthetic of the Device Manager and other system components.
