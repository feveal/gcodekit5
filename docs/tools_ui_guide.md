...
- **Linux:** `~/.config/gcodekit5/custom_tools.json`
- **macOS:** `~/Library/Application Support/gcodekit5/custom_tools.json`
- **Windows:** `%APPDATA%\gcodekit5\custom_tools.json`
...
```bash
# Linux/macOS
cp ~/.config/gcodekit5/custom_tools.json ~/Backups/

# Windows
copy %APPDATA%\gcodekit5\custom_tools.json %USERPROFILE%\Backups\
```
