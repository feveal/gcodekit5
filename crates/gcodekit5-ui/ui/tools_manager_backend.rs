...
use crate::data::gtc_import::{GtcImporter, GtcImportResult};
use crate::data::tools::{Tool, ToolId, ToolLibrary, ToolType, ToolMaterial};
...
impl ToolsManagerBackend {
    pub fn new() -> Self {
        ...
        let mut library = crate::data::tools::init_standard_library();
