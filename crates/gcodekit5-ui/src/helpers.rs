...
pub fn get_grbl_setting_info(
    ...
    match number {
        ...
        5 => ("Invert limit pins", "Invert limit switch pins", "", "System"),
        ...
        13 => ("Report in inches", "Report inches instead of mm", "", "System"),
        ...
        23 => ("Homing direction invert", "Homing direction invert mask", "", "Homing"),
        24 => ("Homing locate feed rate", "Homing locate feed rate", "mm/min", "Homing"),
        25 => ("Homing search seek rate", "Homing search seek rate", "mm/min", "Homing"),
        26 => ("Homing switch debounce delay", "Homing switch debounce", "ms", "Homing"),
        27 => ("Homing switch pull-off distance", "Homing switch pull-off", "mm", "Homing"),
        28 => ("G73 retract distance", "G73 retract distance", "mm", "Motion"),
        29 => ("Pulse delay", "Pulse delay", "μs", "System"),
        30 => ("Maximum spindle speed", "Maximum spindle speed", "RPM", "Spindle"),
        31 => ("Minimum spindle speed", "Minimum spindle speed", "RPM", "Spindle"),
        32 => ("Laser mode enable", "Enable laser mode", "", "Laser"),
        33 => ("Spindle PWM frequency", "Spindle PWM frequency", "Hz", "Spindle"),
        34 => ("Spindle PWM off value", "Spindle PWM off value", "", "Spindle"),
        35 => ("Spindle PWM min value", "Spindle PWM min value", "", "Spindle"),
        36 => ("Spindle PWM max value", "Spindle PWM max value", "", "Spindle"),
        37 => ("Stepper deenergize mask", "Stepper deenergize mask", "", "System"),
        38 => ("Spindle encoder pulses per rev", "Spindle encoder PPR", "", "Spindle"),
        39 => ("Enable legacy RT commands", "Enable legacy RT commands", "", "System"),
        ...
        58 => ("Parking pullout increment", "Parking pullout increment", "", "Parking"),
        59 => ("Parking pullout rate", "Parking pullout rate", "mm/min", "Parking"),
        ...
        64 => ("Force init alarm", "Force initialization alarm", "", "System"),
        65 => ("Probe allow feed override", "Probe allow feed override", "", "Probe"),
        ...
        201 => ("Trinamic homing sensitivity", "Homing sensitivity", "", "Drivers"),
        202 => ("Trinamic hold current %", "Hold current percentage", "%", "Drivers"),
        203 => ("Trinamic run current %", "Run current percentage", "%", "Drivers"),
        204 => ("Trinamic HW current %", "Hardware current percentage", "%", "Drivers"),
        205 => ("Trinamic step interpolation", "Step interpolation enable", "", "Drivers"),
        206 => ("Trinamic PWM chop config", "PWM chopper config", "", "Drivers"),
        ...
        320 => ("Bluetooth device name", "Bluetooth device name", "", "Network"),
        321 => ("Bluetooth service name", "Bluetooth service name", "", "Network"),
        
        340 => ("Tool change mode", "Tool change mode", "", "Tool"),
        341 => ("Tool change probing distance", "Probing distance", "mm", "Tool"),
        342 => ("Tool change locate feed rate", "Locate feed rate", "mm/min", "Tool"),
        343 => ("Tool change search seek rate", "Search seek rate", "mm/min", "Tool"),
        344 => ("Tool change probe pull-off rate", "Probe pull-off rate", "mm/min", "Tool"),
        ...
        384 => ("Disable G92 persistence", "Disable G92 persistence", "", "Motion"),
        385 => ("Dual axis length offset", "Dual axis length offset", "mm", "Motion"),
        ...
        557 => ("Plasma arc voltage scale", "Arc voltage scale", "", "Plasma"),
        558 => ("Plasma arc voltage offset", "Arc voltage offset", "", "Plasma"),
        ...
        603 => ("Encoder feed rate", "Encoder feed rate", "mm/min", "Encoder"),
