...
mod position_size_update_tests {
    ...
    fn test_resize_width_preserves_position() {
        ...
        assert!((initial_center_x - 50.0).abs() < 0.01, "Initial center X should be 50, got {}", initial_center_x);
        assert!((initial_center_y - 50.0).abs() < 0.01, "Initial center Y should be 50, got {}", initial_center_y);
        assert!((initial_width - 60.0).abs() < 0.01, "Initial width should be 60");
        assert!((initial_height - 40.0).abs() < 0.01, "Initial height should be 40");
    ...
    fn test_resize_height_preserves_position() {
        ...
        // Verify initial values
        assert!((initial_center_x - 100.0).abs() < 0.01, "Initial center X should be 100, got {}", initial_center_x);
        assert!((initial_center_y - 100.0).abs() < 0.01, "Initial center Y should be 100, got {}", initial_center_y);
